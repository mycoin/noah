...
public class VelocityEngineFactory {
    ...
    /**
     * Set the location of the Velocity config file. Alternatively, you can
     * specify all properties locally.
     * 
     * @see #setVelocityProperties
     * @see #setResourceLoaderPath
     */
     ...
     * {@code java.io.File}, a generic SpringResourceLoader will be used under
     * the name "spring", without modification detection.
     * <p>
     ...
     * default, the file timestamp is checked on every access (which is
     * surprisingly fast). Of course, this just applies when loading resources
     * from the file system.
     * <p>
     * To enforce the use of SpringResourceLoader, i.e. to not resolve a path as
     * file system resource in any case, turn off the "preferFileSystemAccess"
    ...
    /**
     * Set whether to prefer file system access for template loading. File
     ...
     * Velocity's log system should be set to {@link CommonsLogLogChute}.
     * Default is "true".
     */
