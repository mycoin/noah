...
public class VelocityView extends AbstractTemplateView {
	...
	/**
	 * Set tool attributes to expose to the view, as attribute name / class name pairs. An instance of the given class
	 * will be added to the Velocity context for each rendering operation, under the given attribute name.
	 * <p>
	 * For example, an instance of MathTool, which is part of the generic package of Velocity Tools, can be bound under
	 * the attribute name "math", specifying the fully qualified class name "org.apache.velocity.tools.generic.MathTool"
	 * as value.
	 * <p>
	 * Note that VelocityView can only create simple generic tools or values, that is, classes with a public default
	 * constructor and no further initialization needs. This class does not do any further checks, to not introduce a
	 * required dependency on a specific tools package.
	 * <p>
	 * For tools that are part of the view package of Velocity Tools, a special Velocity context and a special init
	 * callback are needed. Use VelocityToolboxView in such a case, or override {@code createVelocityContext} and
	 * {@code initTool} accordingly.
	 * <p>
	 * For a simple VelocityFormatter instance or special locale-aware instances of DateTool/NumberTool, which are part
	 * of the generic package of Velocity Tools, specify the "velocityFormatterAttribute", "dateToolAttribute" or
	...
	/**
	 * Set the encoding of the Velocity template file. Default is determined by the VelocityEngine: "ISO-8859-1" if not
	 * specified otherwise.
	 * <p>
	 * Specify the encoding in the VelocityEngine rather than per template if all your templates share a common
	 * encoding.
	 */
	 ...
	 * <p>
	 * Have a look at {@link VelocityToolboxView}, which pre-implements ChainedContext support. This is not part of the
	 ...
	 * <p>
	 * Have a look at {@link VelocityToolboxView}, which pre-implements such a ViewTool check. This is not part of the
	 * standard VelocityView class in order to avoid a required dependency on the view package of Velocity Tools.
