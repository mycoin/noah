...
import com.breakidea.noah.ApplicationConstant;
 ...
 * @since 22.01.2004
 */
public abstract class VelocityEngineUtils implements ApplicationConstant {

	public static final String CONTEXT_NAME = VelocityEngineUtils.class.getName().concat(".CONTEXT_NAME");

	public static final String ENGINE_NAME = VelocityEngineUtils.class.getName().concat(".ENGINE_NAME");
	...
	public static void mergeTemplate(VelocityEngine velocityEngine, String templateLocation, String encoding,
		...
		velocityContext.put(ENGINE_NAME, velocityEngine);
		velocityContext.put(CONTEXT_NAME, velocityContext);
	...
	public static void mergeTemplate(VelocityEngine velocityEngine, String templateLocation, Map<String, Object> model,
		...
		mergeTemplate(velocityEngine, templateLocation, defaultCharset, model, writer);
	}
	...
	public static String mergeTemplateIntoString(VelocityEngine velocityEngine, String templateLocation,
		...
		return mergeTemplateIntoString(velocityEngine, templateLocation, defaultCharset, model);
	}
}
