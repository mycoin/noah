<%@ page contentType="image/jpg" import="java.awt.*,java.awt.image.*,java.util.*,javax.imageio.*"%>
...
<%
	...
	for (int i = 0; i < 4; i++) {
		...
		sRand += rand;
		// 设置每个数字的颜色
		g.setColor(new Color(20 + random.nextInt(128), 20 + random.nextInt(128), 20 + random.nextInt(128)));
		//在画板上写数字，起始位置
