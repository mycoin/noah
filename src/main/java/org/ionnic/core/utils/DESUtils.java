...
public class DESUtils {
	...
	public final static String decrypt(String data, String key) throws Exception {
		return new String(decrypt(convertByte(data.getBytes()), key.getBytes()));
	}
	...
	public final static String encrypt(String data, String key) {
		try {
			return convertHex(encrypt(data.getBytes(), key.getBytes()));
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		String content = "阿里巴巴";
		String result = encrypt(content, "12345678");
		String dec = decrypt(result, "12345678");

		System.out.println(result);
		System.out.println(dec.equals(content));
	}
}
